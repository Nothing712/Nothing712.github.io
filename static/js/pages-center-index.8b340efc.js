    ...
    "0121": function (e, t, n) {
        ...
        var o = {uModal: n("8cc6").default}, i = function () {
            ...
            return n("div", {attrs: {id: "div_container"}}, [n("div", {
                ...
                staticClass: "mu-button mu-fab-button mu-button-small mu-inverse animate__animated animate__fadeInDown animate__delay-2s",
                staticStyle: {
                    "user-select": "none",
                    outline: "none",
                    appearance: "none",
                ...
                on: {
                    click: function (t) {
                        arguments[0] = t = e.$handleEvent(t), e.btnModalFn2()
                    }
                }
                ...
                on: {
                    click: function (t) {
                        arguments[0] = t = e.$handleEvent(t), e.openMore.apply(void 0, arguments)
                    }
                }
            }, [n("div", {staticClass: "mu-button-wrapper"}, [n("div", {staticClass: "mu-ripple-wrapper"}), n("span", [e._v("更多")])])])], 1), n("u-modal", {
                attrs: {
                    "show-title": !1,
                    content: e.content
                }, on: {
        ...
        var o = {
            data: function () {
                return {
                    ...
                    img: "mibian\\lzgky.png",
                    mp3Src: "http://music.163.com/song/media/outer/url?id=554241732.mp3",
                    no_data: "要解答",
                    no_list: "这是一首藏头诗#要竖着看哦！",
                    text: "一首小诗❤️",
                    title: "和我👩‍❤️‍👨8️⃣",
                    typed_arr: "我心底有一片荒地 喜是天晴 欢也无雨 你是那天地的神明",
                    yes_data: "收到❤️",
                    yes_list: "美好的事物总是迷人 你也一样#你是所有的心动和满心欢喜#你和晚风 我都要揽入怀抱",
                    footerBtn: !1,
                    modalArr: [],
                    show: !1,
                    content: "",
                    ...
                    audioS: null,
                    onePageShow: !0,
                    t_typed_arr: "(⑉•^•⑉)‥♡$我真的 很喜欢你 很想依赖你 很想和你有个很长的未来 很想把所有的好东西都给你 很想肆无忌惮的爱你 很想每天跟你在一起 很想每天给你大大的拥抱 很想你不开心的时候我都可以哄你 很想你同样依赖于我 很想每天可以说晚安 ❤",
                    footerBtn2: !1,
                    index2: 0,
                    modalArr2: [],
                    yes_list2: "温柔是宝藏#也是你",
